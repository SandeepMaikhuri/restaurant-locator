package com.sandeepmaikhuri.apps.restaurantlocator.domain.executor.impl;
...
public class ThreadExecutor implements RLExecutor
{
     ...
     * the instance.
     */
    public static RLExecutor getInstance()
    {
